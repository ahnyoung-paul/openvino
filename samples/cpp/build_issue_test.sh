...
export OpenVINO_DIR=/home/ahnyoung/cldnn/openvino/build
export OpenCV_DIR=/home/ahnyoung/cldnn/openvino/temp/opencv_4.5.2_ubuntu20/opencv/cmake
...
mkdir -p "$build_dir"
$CMAKE_EXEC -DCMAKE_BUILD_TYPE=Release -S "/home/ahnyoung/cldnn/openvino/samples/cpp/" -B "$build_dir" -DOpenCV_DIR=$PATH_OPENCV/cmake
