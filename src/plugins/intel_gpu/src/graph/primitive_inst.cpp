...
event::ptr primitive_inst::execute(const std::vector<event::ptr>& events) {
    ...
    if ((_node.is_input() == true)
        ...
        && (shape_changed() == true)) {
            ...
            std::cout << " is dynamic " << (_node.is_dynamic() ? "Yes" : "No");
            std::cout << " is input " << (_node.is_input()? "Yes" : "No");
            std::cout << " is constant " << (_node.is_constant() ? "Yes" : "No");
            std::cout << " is shape chagned " << (this->shape_changed()? "Yes" : "No") << "\n";
        }
#endif
