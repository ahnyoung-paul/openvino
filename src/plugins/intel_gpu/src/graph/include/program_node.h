...
public:
    ...
    void replace_dependency(size_t idx, program_node& new_dep, bool remove_if_dangling = true, int32_t new_port_idx = 0);
    ...
    void replace_dependency(program_node const& old_dep, program_node& new_dep, bool remove_if_dangling = true, int32_t new_port_idx = 0);
