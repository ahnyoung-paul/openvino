...
public:
    static void analyze_data(std::string type_str, std::vector<double>& data) {
        ...
        std::cout << std::setw(30) << type_str << "";
        std::cout << "," << std::setw(12) << count;
        std::cout << "," << std::setw(12) << (mean * 1000.0);
        std::cout << "," << std::setw(12) << (min * 1000.0);
        std::cout << "," << std::setw(12) << (max * 1000.0);
        std::cout << std::endl;
    }
    ...
    static void show_perf_result() {
        if (perf_maps.size() > 0) {
            ...
            std::cout << ", " << std::setw(12) << "AVG(ns)";
            std::cout << ", " << std::setw(12) << "MIN(ns)";
            std::cout << ", " << std::setw(10) << "MAX(ns)";
            std::cout << std::endl;
