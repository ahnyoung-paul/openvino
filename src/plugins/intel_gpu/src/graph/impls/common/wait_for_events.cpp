...
attach_data_common::attach_data_common() {
    ...
    impl_hash<data>::add(wait_for_events_impl::get_hash_key<data>);
}
...
attach_input_layout_common::attach_input_layout_common() {
    ...
    impl_hash<input_layout>::add(wait_for_events_impl::get_hash_key<input_layout>);
}
...
attach_prior_box_common::attach_prior_box_common() {
    ...
    impl_hash<prior_box>::add(wait_for_events_impl::get_hash_key<prior_box>);
}
