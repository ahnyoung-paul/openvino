...
public:
    ...
    std::string summary() const {
        ...
        ss << "impl_cache_total_count:" << total_cache_count << std::endl;
        ss << "impl_cache_matched_count:" << total_matched_count << std::endl;
        return ss.str();
    }
...
private:
    ...
    mutable size_t total_cache_count = 0;
    mutable size_t total_matched_count = 0;
