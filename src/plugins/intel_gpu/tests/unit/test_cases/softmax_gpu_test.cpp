...
static void run_softmax_bfyx_opt(const int64_t b, const int64_t f, const int64_t y, const int64_t x) {
    ...
    // const int64_t x_length = x;
    // std::vector<size_t> sample_indices;
    // std::vector<ov::float16> sample_values = { (ov::float16)2.0f, (ov::float16)-3.0f, (ov::float16)22.0f, (ov::float16)18.2f, (ov::float16)10.f};
    // const size_t y_length = b * y * f;
    // for (size_t j = 0; j < y_length; j++) {
    //     for (size_t k = 1; k <= 5; k++) {
    //         sample_indices.push_back(x_length * j + (x_length - 1) * k / 5);
    //     }
    // }
    ...
    //         auto idx = j * 5 + k;
    //         input_data[sample_indices[idx]] = sample_values[k];
    //     }
    // }
    ...
    // {
    //         std::cout << "std::vector<ov::float16> output_ref = {" << std::endl;
    //         const size_t count = static_cast<size_t>(buf_size);
    //         for (size_t idx = 0; idx < count; idx++) {
    //             // float val = static_cast<float>(output_ptr[idx]);
    //             if (output_ptr[idx] != 0.f) {
    //                 std::cout << std::fixed << std::setprecision(6) << "(ov::float16)" << output_ptr[idx] << "f";
    //             } else {
    //                 std::cout << std::fixed << std::setprecision(6) << output_ptr[idx];
    //             }
    //             if (idx < (count - 1))
    //                 std::cout << ",";
    //             if ((idx + 1) % 20 == 0)
    ...
    // }
    // {
    //     std::string filename = "C:\\dev\\ahnyoung\\dumps\\test03\\good\\expected_output_dump_net_softmax.txt";
    ...
    //             // float val = static_cast<float>(output_ptr[idx]);
    //             if (output_ptr[idx] != 0.f) {
    //                 of << std::fixed << std::setprecision(6) << "(ov::float16)" << output_ptr[idx] << "f";
    //             } else {
    //                 of << std::fixed << std::setprecision(6) << output_ptr[idx];
    //             }
    //             if (idx < (count - 1))
    //                 of << ",";
    //             if ((idx + 1) % 20 == 0)
    ...
    //         }
    //         of << "};" << std::endl;
    //         std::cout << "Dump output data : " << filename << std::endl;
    //     }
    // }
// #if 0
...
//     output_ref[1034]=(ov::float16)0.00000602f;
//     output_ref[1655]=(ov::float16)0.97802734f;
//     output_ref[1862]=(ov::float16)0.02197266f;
//     output_ref[2069]=(ov::float16)0.00000602f;
//     output_ref[2690]=(ov::float16)0.97802734f;
//     output_ref[2897]=(ov::float16)0.02197266f;
//     output_ref[3104]=(ov::float16)0.00000602f;
